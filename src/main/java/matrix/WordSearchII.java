...
public class WordSearchII {
  ...
  public static List<String> findWord(char[][] board, String[] word) {
  ...
  public static void main(String[] args) {
    ...
    List<String> list = findWord(board, word);
    long end = System.nanoTime();
    long elapsedTime = end - start;
    double elapsedTimeInSecond = (double) elapsedTime / 1e-6;
    System.out.println(elapsedTimeInSecond + " ms");
