...
import LowLoevelSystemDesign.chesslld.chess.model.Color;
import LowLoevelSystemDesign.chesslld.chess.model.Piece;
import LowLoevelSystemDesign.chesslld.chess.model.PieceType;;
import LowLoevelSystemDesign.chesslld.chess.moves.VerticalMoveDirection;
import com.google.common.collect.ImmutableList;
import java.util.ArrayList;
import java.util.List;

//https://github.com/anomaly2104/chess-low-level-system-design/blob/1bf2ead398/src/test/java/com/uditagarwal/chess/GamePlay.java
...
/*
  public static List<Piece> piecesSet(Color color, Board board, int mainPiecesRownNum, int pawnPiecesRowNum,
      VerticalMoveDirection pawnDirection) {
    ...
    ImmutableList<Piece> mainPieces = ImmutableList.of(king, queen, rook1, rook2, bishop1, bishop2, knight1,
        knight2);
  ...
  public static Piece randomPiece() {
    return pawn(Color.WHITE, VerticalMoveDirection.BOTH);
  }
  ...
  public static Piece pawn(Color color, VerticalMoveDirection pawnDirection) {
    ImmutableList<PossibleMovesProvider> pawnMoveProviders = ImmutableList.of(
        new PossibleMovesProviderVertical(1, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker(), pawnDirection),
        new PossibleMovesProviderVertical(2, new MoveBaseConditionFirstMove(), defaultMoveFurtherCondition(),
            defaultBaseBlocker(), pawnDirection)
    );
  ...
  public static Piece king(Color color) {
    ImmutableList<PossibleMovesProvider> pawnMoveProviders = ImmutableList.of(
        new PossibleMovesProviderVertical(1, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker(), BOTH),
        new PossibleMovesProviderHorizontal(1, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker()),
        new PossibleMovesProviderDiagonal(1, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker())
    );
  ...
  public static Piece queen(Color color) {
    ImmutableList<PossibleMovesProvider> pawnMoveProviders = ImmutableList.of(
        new PossibleMovesProviderVertical(8, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker(), BOTH),
        new PossibleMovesProviderHorizontal(8, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker()),
        new PossibleMovesProviderDiagonal(8, new NoMoveBaseCondition(), defaultMoveFurtherCondition(),
            defaultBaseBlocker())
    );
