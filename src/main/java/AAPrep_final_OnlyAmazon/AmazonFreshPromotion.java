...
//http://www.drpapaya.com/post/19/
//https://www.youtube.com/watch?v=PBBEehnUW_8
//https://swabhaw.com/2020/10/07/amazon-fresh-promotion/
public class AmazonFreshPromotion {
  ...
  private static int isCustomerWinner(String[][] codeList, String[] shoppingCart) {
  ...
  public static void main(String[] args) {
    ...
    String[][] codeList9 = {{"anything", "anything", "anything", "apple"},
